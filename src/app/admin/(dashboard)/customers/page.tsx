...
import { Search, Trophy, Medal, Award, X, Mail, Phone, MapPin, Calendar, CreditCard, Plus, Minus } from "lucide-react";
...
export default function AdminCustomersPage() {
  const { customers, updateCustomerPoints } = useAdminStore();
